...
export const SelectFaceToTrack = ({
  ...
  return (
    <div className="hidden md:flex flex-col items-center gap-3">
      ...
      <div className="flex items-center gap-4 bg-white/5 dark:bg-white/5 p-2 rounded-full border border-gray-200 dark:border-white/10">
        {faces.map((face, index) => {
          ...
          return (
            ...
            >
              <div
                className={`relative size-12 rounded-full overflow-hidden transition-all ${
                  isSelected
