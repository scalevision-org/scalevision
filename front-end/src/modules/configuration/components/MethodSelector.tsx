    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="aspect-video rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center bg-black/5 dark:bg-black/20">
                <div className={`w-1/3 h-full border-2 ${
                  selectedMethod === "center" ? "border-primary" : "border-slate-400 dark:border-slate-600"
                }`} />
              </div>
            </div>
          ...
          >
            <div className="aspect-video rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 relative overflow-hidden">
              <div className={`absolute left-1/4 top-0 w-1/3 h-full border-2 ${
                selectedMethod === "smart" ? "border-primary bg-primary/20" : "border-slate-400 dark:border-slate-600 bg-slate-200/50 dark:bg-slate-700/50"
              }`}>
                <div className={`absolute top-2 left-2 text-white text-[10px] px-2 py-[2px] rounded font-semibold ${
